  ...
  return (
    ...
    {/* mobile menu */}
      ...
      <ul onClick={handleNav}
        className={`fixed top-14 bottom-0 right-0 h-full bg-blue-400 z-20 w-full list-none p-5 flex flex-col transition-all duration-700 ease-in  ${
          open ? 'opacity-100' : ' -top-80 opacity-0'
        }`}
      >
